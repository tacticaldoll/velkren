...
- [ ] 3.4 Implement `patchKeyedChildren` in `packages/solid-adapter/src/index.ts` as follows (order matters — this fixes a transition-case DOM leak an adversarial review caught in the propose stage, see design.md's Decisions/Risks):
