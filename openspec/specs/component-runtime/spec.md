...
Define runtime-isolated component definitions, managed component instances, logical instance trees, explicit scoped visibility, and owner-validated references, composed onto the shared ownership, registration, and managed-lifecycle kernel without renderer, DOM, or reactive dependencies.
...
- **WHEN** a caller uses a reference whose target instance has been released
