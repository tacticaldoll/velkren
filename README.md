...
Velkren's runtime foundation, typed namespace loading, semantic events, managed endpoints, listeners, middleware, relayers, and plugin transactions are specified and implemented. No OpenSpec change is currently active; the component runtime is the next ready outcome in the dependency-ordered backlog.
